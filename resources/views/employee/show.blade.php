                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="{{asset($emp->picture)}}"
                        ...
                        <p class="text-muted text-center">{{$emp->position_name->name}} -
                            {{$emp->department_name->name}}</p>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>ອີເມວ</b> <a class="float-right">{{$emp->email}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>ເພດ</b>
                                <a class="float-right">
                        ...
                        <a href="{{route('employee.printcart',$emp->id)}}" target="_blank" class="btn btn-warning"><i
                                class="fas fa-print"></i> ພີມ</a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
            ...
            <div class="col-md-8">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                            {{$emp->address}} - {{$emp->villname->name}} - {{$emp->disname->name}} -
                            {{$emp->proname->name}}
                        ...
                        <p class="text-muted"> {{$emp->statusname->name}} - {{$emp->mar_name}} - {{$emp->mar_work}} -
                            {{$emp->mar_address}} - {{$emp->mar_phone}} </p>
