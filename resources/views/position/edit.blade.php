        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">ຕຳແໜ່ງງານ</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card card-default">
                ...
                <form method="POST" action="{{route('position.update', $position->id)}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">ຊື່ຕຳແໜ່ງງານ</label>
                                            <input type="text" class="form-control" name="name"
                                                value="{{$position->name}}" placeholder="ຊື່ຕຳແໜ່ງງານ">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-warning" href="{{route('position.index')}}">ກັບຄືນ</a>
                    </div>
                </form>
