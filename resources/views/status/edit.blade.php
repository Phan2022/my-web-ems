        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">ສະຖານະພາບ</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card card-default">
                ...
                <form method="POST" action="{{route('status.update', $status->id)}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">ຊື່ສະຖານະພາບ</label>
                                            <input type="text" class="form-control" name="name"
                                                value="{{$status->name}}" placeholder="ຊື່ສະຖານະພາບ">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-warning" href="{{route('status.index')}}">ກັບຄືນ</a>
                    </div>
                </form>
