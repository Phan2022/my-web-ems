...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="../../dist/img/user2-160x160.jpg" class="user-image img-circle elevation-2"
                            alt="User Image">
                        <span class="d-none d-md-inline">{{Auth::user()->phone}}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            <a href="{{route('user.edit', Auth::user()->id)}}"
                                class="btn btn-default btn-flat">ຂໍ້ມມູນສ່ວນຕົວ</a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <a href="https://www.phanliddasak.com" target="_blank">Phan Liddask</a>.</strong>
            All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
